...
Check if a tools requires parameters that can be provided by the other tools and call those tools first and if there is a single choice then continue with that data else ask the user.
"""
)