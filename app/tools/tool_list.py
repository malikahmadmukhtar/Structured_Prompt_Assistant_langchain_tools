...
from app.tools.facebook.facebook_ad import create_facebook_ad, get_facebook_ads
...
declared_tool_list=[
    ...
    start_creative_creation,## page id missing
    create_catalog_creative,## not tested
